...
void Program::save(const double* q, double* qold) {
	for (int n = 0; n < 4; n++)
		qold[n] = q[n];
}

void Program::area(const double* x1, const double* x2, const double* x3,
...
void Program::flux(const double* x1, const double* x2, const double* q1,
...
void Program::bcond(const double* x1, const double* x2, const double* q1,
...
void Program::update(const double* qold, double* q, double* res,
